...
const timeSlots: { id: TimeSlot; label: string; time: string; color: string }[] = [
  { id: 'morning', label: 'Morning', time: '8:00 AM – 12:00 PM', color: '#F59E0B' },
...
export default function BookingScreen() {
  ...
  const canConfirm = Boolean(selectedDate && selectedSlot && purpose.trim());
    ...
    return (
      <View style={[styles.successContainer, { paddingTop: insets.top }]}>
        ...
        <Text style={styles.successSlot}>
          {timeSlots.find((t) => t.id === selectedSlot)?.time}
        </Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('LabList')} style={{ marginTop: 12 }}>
  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {/* Purpose */}
        <View style={styles.sectionBlock}>
          <Text style={styles.sectionLabel}>Purpose / Reason</Text>
          <TextInput
            style={styles.purposeInput}
            value={purpose}
            onChangeText={setPurpose}
            placeholder="Describe your purpose for using this lab..."
